...
export default function BungaTetap() {
    ...
    const submitHandler = (e) => {
        ...
        const fv = parseFloat(values.pv) + (parseFloat(values.pv) * (parseFloat(values.i) / 100) * parseFloat(values.n))
                ...
                <div className="card-body">
                    <form onSubmit={submitHandler}>
                        <div className="row mb-4">
                            <label htmlFor="pv" className="col-sm-3 col-form-label">Nilai Uang Sekarang (PV)</label>
                            <div className="col-sm-9">
                                <input type="text" className="form-control" id="pv" placeholder="0" onChange={inputHandler} />
                            </div>
                        </div>
                        <div className="row mb-4">
...
BungaTetap.layout = (page) => <App children={page} title="Bunga Tetap" />